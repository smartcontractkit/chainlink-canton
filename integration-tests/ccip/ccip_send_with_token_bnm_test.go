...
import (
	...
	"github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/clientapi"
	...
	executorBinding "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/executor"
...
func TestBnMTokenPool_FullSendFlow(t *testing.T) {
	...
	dars := [][]byte{runtimeDar, coreDar, committeeVerifierDar, ccipSenderDar, ccipExecutorDar, tokenPoolDar, linkTokenDar}
