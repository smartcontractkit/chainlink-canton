...
require (
	...
	github.com/smartcontractkit/chainlink-ccv v0.0.0-20260408185451-7b2512c2651c // indirect
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.15.15 // indirect
