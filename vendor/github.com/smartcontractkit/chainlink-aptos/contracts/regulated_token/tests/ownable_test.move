#[test_only]
module regulated_token::ownable_test {
    use std::signer;
    ...
    #[test]
    #[expected_failure(abort_code = 327681, location = regulated_token::ownable)]
    ...
    #[test]
    #[expected_failure(abort_code = 327686, location = regulated_token::ownable)]
    ...
    #[test]
    #[expected_failure(abort_code = 196615, location = regulated_token::ownable)]
    ...
    #[test]
    #[expected_failure(abort_code = 327684, location = regulated_token::ownable)]
    ...
    #[test]
    #[expected_failure(abort_code = 327685, location = regulated_token::ownable)]
    // E_OWNER_CHANGED
