...
- **INV-ENC-1**: `ExtraArgsV3` tag is `0xa69dd4aa`. Any extraArgs with this 4-byte prefix is decoded as V3. All chains should use the same extraArgs format, not a chain spefic one.
