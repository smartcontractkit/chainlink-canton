...
import (
	...
	burnminttokenpool "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/burnminttokenpool"
	ccipcodec "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/ccipcodec"
	ccipruntime "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/ccipruntime"
	committeeverifier "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/committeeverifier"
	core "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/core"
	executor "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/executor"
	lockreleasetokenpool "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/lockreleasetokenpool"
	ratelimiter "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/ratelimiter"
	chainlinkapi "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/chainlink/chainlinkapi"
	link "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/link"
...
const (
	...
	PackageID   = "3a262bd6f3ad98e715057434c052d56cea01494ea290776c2c6ebdf3c7c67a28"
	SDKVersion  = "3.4.11"
)
...
func (t CCIPFactory) GetTemplateID() string {
	return fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.FactoryV2", "CCIPFactory")
}

// GetTemplateIDWithPackageID returns the template ID using the provided package ID instead of package name
func (t CCIPFactory) GetTemplateIDWithPackageID(packageID string) string {
	return fmt.Sprintf("%s:%s:%s", packageID, "CCIP.FactoryV2", "CCIPFactory")
}
...
func (t CCIPFactory) DeployGlobalConfig(contractID string, args DeployGlobalConfig) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.FactoryV2", "CCIPFactory"),
...
func (t CCIPFactory) DeployGlobalConfigWithPackageID(contractID string, packageID string, args DeployGlobalConfig) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.FactoryV2", "CCIPFactory"),
		ContractID: contractID,
		Choice:     "DeployGlobalConfig",
		Arguments:  argsToMap(args),
	}
...
func (t CCIPFactory) Archive(contractID string) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.FactoryV2", "MCMSReceiver"),
		ContractID: contractID,
		Choice:     "Archive",
...
func (t CCIPFactory) ArchiveWithPackageID(contractID string, packageID string) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.FactoryV2", "MCMSReceiver"),
		ContractID: contractID,
		Choice:     "Archive",
		Arguments:  map[string]any{},
	}
