...
const (
	PackageName = "ccip-registry-lock-release-token-pool-v2" // TEMP: revert after v1 DARs are vetted
	PackageID   = "42c39df6943667e9ee2aeee1055cf88ba76724a16046ba76ead3333f25b07207"
	SDKVersion  = "3.4.11"
)
...
// Initialize is a Record type
type Initialize struct {
	TokenAdminRegistryCid  types.CONTRACT_ID  `json:"tokenAdminRegistryCid"`
	ExistingTokenConfigCid *types.CONTRACT_ID `json:"existingTokenConfigCid" hex:"optional"`
	Admin                  types.PARTY        `json:"admin"`
	Lanes                  []LaneDeploySpec   `json:"lanes"`
}

// ToMap converts Initialize to a map for DAML arguments
func (t Initialize) ToMap() map[string]any {
	m := make(map[string]any)

	m["tokenAdminRegistryCid"] = model.NestedToDAMLValue(t.TokenAdminRegistryCid)

	if t.ExistingTokenConfigCid != nil {
		m["existingTokenConfigCid"] = map[string]any{
			"_type": "optional",
			"value": model.NestedToDAMLValue(*t.ExistingTokenConfigCid),
		}
	} else {
		m["existingTokenConfigCid"] = map[string]any{
			"_type": "optional",
	...
	m["lanes"] = func() []any {
		res := make([]any, 0, len(t.Lanes))
		for _, e := range t.Lanes {
			res = append(res, model.NestedToDAMLValue(e))
		}
		return res
	}()
...
func (t Initialize) MarshalJSON() ([]byte, error) {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Marshal(t)
}

func (t *Initialize) UnmarshalJSON(data []byte) error {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Unmarshal(data, t)
}

// MarshalHex encodes Initialize to hex string (Canton MCMS format)
func (t Initialize) MarshalHex() (string, error) {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Marshal(t)
}

// UnmarshalHex decodes Initialize from hex string (Canton MCMS format)
func (t *Initialize) UnmarshalHex(data string) error {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Unmarshal(data, t)
}

// InitializeResult is a Record type
type InitializeResult struct {
	RateLimiterCids []types.CONTRACT_ID `json:"rateLimiterCids"`
	TokenConfigCid  types.CONTRACT_ID   `json:"tokenConfigCid"`
}

// ToMap converts InitializeResult to a map for DAML arguments
func (t InitializeResult) ToMap() map[string]any {
	m := make(map[string]any)

	m["rateLimiterCids"] = func() []any {
		res := make([]any, 0, len(t.RateLimiterCids))
		for _, e := range t.RateLimiterCids {
			res = append(res, e)
		}
		return res
	}()
...
func (t InitializeResult) MarshalJSON() ([]byte, error) {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Marshal(t)
}

func (t *InitializeResult) UnmarshalJSON(data []byte) error {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Unmarshal(data, t)
}

// MarshalHex encodes InitializeResult to hex string (Canton MCMS format)
func (t InitializeResult) MarshalHex() (string, error) {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Marshal(t)
}

// UnmarshalHex decodes InitializeResult from hex string (Canton MCMS format)
func (t *InitializeResult) UnmarshalHex(data string) error {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Unmarshal(data, t)
}

// LaneDeploySpec is a Record type
type LaneDeploySpec struct {
	RemoteChainSelector   types.NUMERIC                     `json:"remoteChainSelector"`
	RemotePools           []types.TEXT                      `json:"remotePools" hex:"[]bytes"`
	RemoteTokenAddress    types.TEXT                        `json:"remoteTokenAddress" hex:"bytes"`
	InboundCCVs           []chainlinkapi.RawInstanceAddress `json:"inboundCCVs"`
	...
	Outbound              RateLimiterDeploySpec             `json:"outbound"`
	InboundCustomFinality RateLimiterDeploySpec             `json:"inboundCustomFinality"`
}

// ToMap converts LaneDeploySpec to a map for DAML arguments
func (t LaneDeploySpec) ToMap() map[string]any {
	m := make(map[string]any)
	...
	m["inbound"] = model.NestedToDAMLValue(t.Inbound)

	m["outbound"] = model.NestedToDAMLValue(t.Outbound)
...
func (t LaneDeploySpec) MarshalJSON() ([]byte, error) {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Marshal(t)
}

func (t *LaneDeploySpec) UnmarshalJSON(data []byte) error {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Unmarshal(data, t)
}

// MarshalHex encodes LaneDeploySpec to hex string (Canton MCMS format)
func (t LaneDeploySpec) MarshalHex() (string, error) {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Marshal(t)
}

// UnmarshalHex decodes LaneDeploySpec from hex string (Canton MCMS format)
func (t *LaneDeploySpec) UnmarshalHex(data string) error {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Unmarshal(data, t)
}
...
func (t LockReleaseTokenPool) GetTemplateID() string {
	return fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.LockReleaseTokenPoolV2", "LockReleaseTokenPool")
}

// GetTemplateIDWithPackageID returns the template ID using the provided package ID instead of package name
func (t LockReleaseTokenPool) GetTemplateIDWithPackageID(packageID string) string {
	return fmt.Sprintf("%s:%s:%s", packageID, "CCIP.Registry.LockReleaseTokenPoolV2", "LockReleaseTokenPool")
}
...
// Initialize exercises the Initialize choice on this LockReleaseTokenPool contract
// This method uses the package name in the template ID
func (t LockReleaseTokenPool) Initialize(contractID string, args Initialize) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.LockReleaseTokenPoolV2", "LockReleaseTokenPool"),
		ContractID: contractID,
		Choice:     "Initialize",
...
// InitializeWithPackageID exercises the Initialize choice using the provided package ID instead of package name
func (t LockReleaseTokenPool) InitializeWithPackageID(contractID string, packageID string, args Initialize) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.LockReleaseTokenPoolV2", "LockReleaseTokenPool"),
		ContractID: contractID,
		Choice:     "Initialize",
...
// SetObservers exercises the SetObservers choice on this LockReleaseTokenPool contract
// This method uses the package name in the template ID
func (t LockReleaseTokenPool) SetObservers(contractID string, args SetObservers) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.LockReleaseTokenPoolV2", "LockReleaseTokenPool"),
		ContractID: contractID,
		Choice:     "SetObservers",
...
func (t LockReleaseTokenPool) SetObserversWithPackageID(contractID string, packageID string, args SetObservers) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.LockReleaseTokenPoolV2", "LockReleaseTokenPool"),
		ContractID: contractID,
		Choice:     "SetObservers",
...
func (t LockReleaseTokenPool) Archive(contractID string) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.LockReleaseTokenPoolV2", "TokenPool"),
		ContractID: contractID,
		Choice:     "Archive",
...
func (t LockReleaseTokenPool) ArchiveWithPackageID(contractID string, packageID string) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.LockReleaseTokenPoolV2", "TokenPool"),
		ContractID: contractID,
		Choice:     "Archive",
		Arguments:  map[string]any{},
	}
...
func (t LockReleaseTokenPool) MCMSReceiverEntrypoint(contractID string, args api.MCMSReceiverEntrypoint) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.LockReleaseTokenPoolV2", "MCMSReceiver"),
		ContractID: contractID,
...
func (t LockReleaseTokenPool) MCMSReceiverEntrypointWithPackageID(contractID string, packageID string, args api.MCMSReceiverEntrypoint) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.LockReleaseTokenPoolV2", "MCMSReceiver"),
		ContractID: contractID,
		Choice:     "MCMSReceiver_Entrypoint",
		Arguments:  argsToMap(args),
	}
...
func (t LockReleaseTokenPool) TokenPoolGetRequiredCCVs(contractID string, args extensionapi.TokenPoolGetRequiredCCVs) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.LockReleaseTokenPoolV2", "ITokenPool"),
		ContractID: contractID,
...
func (t LockReleaseTokenPool) TokenPoolGetRequiredCCVsWithPackageID(contractID string, packageID string, args extensionapi.TokenPoolGetRequiredCCVs) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.LockReleaseTokenPoolV2", "ITokenPool"),
		ContractID: contractID,
		Choice:     "TokenPool_GetRequiredCCVs",
		Arguments:  argsToMap(args),
	}
...
var _ api.IMCMSReceiver = (*LockReleaseTokenPool)(nil)

var _ extensionapi.IITokenPool = (*LockReleaseTokenPool)(nil)
...
// RateLimiterDeploySpec is a Record type
type RateLimiterDeploySpec struct {
	InstanceId types.TEXT    `json:"instanceId"`
...
// ToMap converts RateLimiterDeploySpec to a map for DAML arguments
func (t RateLimiterDeploySpec) ToMap() map[string]any {
	m := make(map[string]any)
...
func (t RateLimiterDeploySpec) MarshalJSON() ([]byte, error) {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Marshal(t)
}

func (t *RateLimiterDeploySpec) UnmarshalJSON(data []byte) error {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Unmarshal(data, t)
}

// MarshalHex encodes RateLimiterDeploySpec to hex string (Canton MCMS format)
func (t RateLimiterDeploySpec) MarshalHex() (string, error) {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Marshal(t)
}

// UnmarshalHex decodes RateLimiterDeploySpec from hex string (Canton MCMS format)
func (t *RateLimiterDeploySpec) UnmarshalHex(data string) error {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Unmarshal(data, t)
}
...
type MCMSEncoder interface {
	...
	Initialize(args Initialize) (*bind.EncodedChoice, error)
...
// Initialize encodes parameters for the Initialize choice.
func (e *encoder) Initialize(args Initialize) (*bind.EncodedChoice, error) {
	return e.EncodeChoiceArgs("Initialize", args)
}
