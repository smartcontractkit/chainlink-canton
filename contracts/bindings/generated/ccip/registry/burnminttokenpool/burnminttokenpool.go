...
const (
	PackageName = "ccip-registry-burn-mint-token-pool-v2" // TEMP: revert after v1 DARs are vetted
...
func (t BurnMintTokenPool) GetTemplateID() string {
	return fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.BurnMintTokenPoolV2", "BurnMintTokenPool")
}

// GetTemplateIDWithPackageID returns the template ID using the provided package ID instead of package name
func (t BurnMintTokenPool) GetTemplateIDWithPackageID(packageID string) string {
	return fmt.Sprintf("%s:%s:%s", packageID, "CCIP.Registry.BurnMintTokenPoolV2", "BurnMintTokenPool")
}
...
// Initialize exercises the Initialize choice on this BurnMintTokenPool contract
// This method uses the package name in the template ID
func (t BurnMintTokenPool) Initialize(contractID string, args Initialize) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.BurnMintTokenPoolV2", "BurnMintTokenPool"),
		ContractID: contractID,
		Choice:     "Initialize",
...
func (t BurnMintTokenPool) InitializeWithPackageID(contractID string, packageID string, args Initialize) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.BurnMintTokenPoolV2", "BurnMintTokenPool"),
		ContractID: contractID,
		Choice:     "Initialize",
...
func (t BurnMintTokenPool) Archive(contractID string) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.BurnMintTokenPoolV2", "TokenPool"),
		ContractID: contractID,
		Choice:     "Archive",
...
func (t BurnMintTokenPool) ArchiveWithPackageID(contractID string, packageID string) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.BurnMintTokenPoolV2", "TokenPool"),
		ContractID: contractID,
		Choice:     "Archive",
		Arguments:  map[string]any{},
	}
...
func (t BurnMintTokenPool) MCMSReceiverEntrypoint(contractID string, args api.MCMSReceiverEntrypoint) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.BurnMintTokenPoolV2", "MCMSReceiver"),
		ContractID: contractID,
...
func (t BurnMintTokenPool) MCMSReceiverEntrypointWithPackageID(contractID string, packageID string, args api.MCMSReceiverEntrypoint) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.BurnMintTokenPoolV2", "MCMSReceiver"),
		ContractID: contractID,
		Choice:     "MCMSReceiver_Entrypoint",
		Arguments:  argsToMap(args),
	}
...
func (t BurnMintTokenPool) TokenPoolGetRequiredCCVs(contractID string, args extensionapi.TokenPoolGetRequiredCCVs) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", PackageName, "CCIP.Registry.BurnMintTokenPoolV2", "ITokenPool"),
		ContractID: contractID,
...
func (t BurnMintTokenPool) TokenPoolGetRequiredCCVsWithPackageID(contractID string, packageID string, args extensionapi.TokenPoolGetRequiredCCVs) *model.ExerciseCommand {
	return &model.ExerciseCommand{
		TemplateID: fmt.Sprintf("#%s:%s:%s", packageID, "CCIP.Registry.BurnMintTokenPoolV2", "ITokenPool"),
		ContractID: contractID,
		Choice:     "TokenPool_GetRequiredCCVs",
		Arguments:  argsToMap(args),
	}
