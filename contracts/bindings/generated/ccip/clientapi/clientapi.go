...
import (
	...
	extensionapi "github.com/smartcontractkit/chainlink-canton/contracts/bindings/generated/ccip/extensionapi"
...
// IICCIPMessageSent is a DAML interface
type IICCIPMessageSent interface {

	// Archive executes the Archive choice
	Archive(contractID string) *model.ExerciseCommand
}

// IIExecutionStateChanged is a DAML interface
type IIExecutionStateChanged interface {
...
func (t CCIPMessageSentView) ToMap() map[string]any {
...
func (t CCIPMessageSentView) MarshalJSON() ([]byte, error) {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Marshal(t)
}

func (t *CCIPMessageSentView) UnmarshalJSON(data []byte) error {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Unmarshal(data, t)
}

// MarshalHex encodes CCIPMessageSentView to hex string (Canton MCMS format)
func (t CCIPMessageSentView) MarshalHex() (string, error) {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Marshal(t)
}

// UnmarshalHex decodes CCIPMessageSentView from hex string (Canton MCMS format)
func (t *CCIPMessageSentView) UnmarshalHex(data string) error {
	hexCodec := codec.NewHexCodec()
...
func (t ExecutionStateChangedView) ToMap() map[string]any {
	m := make(map[string]any)
...
func (t ExecutionStateChangedView) MarshalJSON() ([]byte, error) {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Marshal(t)
}

func (t *ExecutionStateChangedView) UnmarshalJSON(data []byte) error {
	jsonCodec := codec.NewJsonCodec()
	return jsonCodec.Unmarshal(data, t)
}

// MarshalHex encodes ExecutionStateChangedView to hex string (Canton MCMS format)
func (t ExecutionStateChangedView) MarshalHex() (string, error) {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Marshal(t)
}

// UnmarshalHex decodes ExecutionStateChangedView from hex string (Canton MCMS format)
func (t *ExecutionStateChangedView) UnmarshalHex(data string) error {
	hexCodec := codec.NewHexCodec()
	return hexCodec.Unmarshal(data, t)
}
