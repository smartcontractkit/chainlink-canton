...
import (
	v30 "github.com/smartcontractkit/chainlink-canton-internal/pb/gen/com/digitalasset/canton/admin/sequencer/v30"
	v301 "github.com/smartcontractkit/chainlink-canton-internal/pb/gen/com/digitalasset/canton/admin/time/v30"
...
func (x *SynchronizerConnectionConfig) GetSynchronizerId() string {
	if x != nil {
...
type ModifySynchronizerRequest struct {
	state                         protoimpl.MessageState            `protogen:"open.v1"`
	NewConfig                     *SynchronizerConnectionConfig     `protobuf:"bytes,1,opt,name=new_config,json=newConfig,proto3" json:"new_config,omitempty"`
...
const file_com_digitalasset_canton_admin_participant_v30_synchronizer_connectivity_proto_rawDesc = "" +
	...
	"\x0emanual_connect\x18\x03 \x01(\bR\rmanualConnect\x12'\n" +
	...
	"\n" +
	"new_config\x18\x01 \x01(\v2K.com.digitalasset.canton.admin.participant.v30.SynchronizerConnectionConfigR\tnewConfig\x12\x92\x01\n" +
	"\x1fsequencer_connection_validation\x18\x02 \x01(\x0e2J.com.digitalasset.canton.admin.sequencer.v30.SequencerConnectionValidationR\x1dsequencerConnectionValidation\"\x1c\n" +
	"\x1aModifySynchronizerResponse\"$\n" +
	"\"ListRegisteredSynchronizersRequest\"\xa8\x02\n" +
	"#ListRegisteredSynchronizersResponse\x12s\n" +
	"\aresults\x18\x01 \x03(\v2Y.com.digitalasset.canton.admin.participant.v30.ListRegisteredSynchronizersResponse.ResultR\aresults\x1a\x8b\x01\n" +
	"\x06Result\x12c\n" +
	...
	"\x17connected_synchronizers\x18\x01 \x03(\v2X.com.digitalasset.canton.admin.participant.v30.ListConnectedSynchronizersResponse.ResultR\x16connectedSynchronizers\x1az\n" +
	"\x06Result\x12-\n" +
	"\x12synchronizer_alias\x18\x01 \x01(\tR\x11synchronizerAlias\x12'\n" +
	"\x0fsynchronizer_id\x18\x02 \x01(\tR\x0esynchronizerId\x12\x18\n" +
	"\ahealthy\x18\x03 \x01(\bR\ahealthy\"I\n" +
