...
type Contract struct {
	...
	LedgerCreateTime    *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=ledger_create_time,json=ledgerCreateTime,proto3" json:"ledger_create_time,omitempty"` // in microseconds of UTC time since Unix epoch
	ContractSalt        *v30.Salt              `protobuf:"bytes,5,opt,name=contract_salt,json=contractSalt,proto3" json:"contract_salt,omitempty"`               // optional
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type Contract_Metadata struct {
	...
	Key                      *Contract_GlobalKey    `protobuf:"bytes,3,opt,name=key,proto3" json:"key,omitempty"`                 // optional: only set if contract has a key
...
const file_com_digitalasset_canton_admin_participant_v30_active_contract_proto_rawDesc = "" +
	"\n" +
	"Ccom/digitalasset/canton/admin/participant/v30/active_contract.proto\x12-com.digitalasset.canton.admin.participant.v30\x1a5com/digitalasset/canton/admin/crypto/v30/crypto.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15scalapb/scalapb.proto\"\xfd\x01\n" +
	...
	"\x14reassignment_counter\x18\x03 \x01(\x03R\x13reassignmentCounter:7\xe2?4\x122com.digitalasset.canton.version.StableProtoVersion\"\xbf\x05\n" +
	"\bContract\x12\x1f\n" +
	...
	"\x12ledger_create_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x10ledgerCreateTime\x12S\n" +
	"\rcontract_salt\x18\x05 \x01(\v2..com.digitalasset.canton.admin.crypto.v30.SaltR\fcontractSalt\x1a\xfd\x01\n" +
	"\bMetadata\x12<\n" +
...
var file_com_digitalasset_canton_admin_participant_v30_active_contract_proto_goTypes = []any{
	...
	(*v30.Salt)(nil),              // 6: com.digitalasset.canton.admin.crypto.v30.Salt
}
var file_com_digitalasset_canton_admin_participant_v30_active_contract_proto_depIdxs = []int32{
	...
	6, // 3: com.digitalasset.canton.admin.participant.v30.Contract.contract_salt:type_name -> com.digitalasset.canton.admin.crypto.v30.Salt
	4, // 4: com.digitalasset.canton.admin.participant.v30.Contract.Metadata.key:type_name -> com.digitalasset.canton.admin.participant.v30.Contract.GlobalKey
