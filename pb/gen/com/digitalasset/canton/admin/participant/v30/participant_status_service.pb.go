...
func (x *ConnectedSynchronizer) GetSynchronizerId() string {
	if x != nil {
...
const file_com_digitalasset_canton_admin_participant_v30_participant_status_service_proto_rawDesc = "" +
	...
	"\x0fsynchronizer_id\x18\x01 \x01(\tR\x0esynchronizerId\x12c\n" +
