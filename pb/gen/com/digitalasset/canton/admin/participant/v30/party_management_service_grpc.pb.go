...
const (
	...
	PartyManagementService_CompletePartyOnboarding_FullMethodName     = "/com.digitalasset.canton.admin.participant.v30.PartyManagementService/CompletePartyOnboarding"
)
...
type PartyManagementServiceClient interface {
	...
	//
	// Finalizes a party's onboarding by having the target participant unilaterally remove the onboarding flag on the
	// party to participant topology mapping.
	//
	// The successful removal depends on the change history of the dynamic synchronizer's confirmation response timeout
	// and the mediator reaction timeout parameters.
	CompletePartyOnboarding(ctx context.Context, in *CompletePartyOnboardingRequest, opts ...grpc.CallOption) (*CompletePartyOnboardingResponse, error)
}
...
func (c *partyManagementServiceClient) CompletePartyOnboarding(ctx context.Context, in *CompletePartyOnboardingRequest, opts ...grpc.CallOption) (*CompletePartyOnboardingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompletePartyOnboardingResponse)
	err := c.cc.Invoke(ctx, PartyManagementService_CompletePartyOnboarding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PartyManagementServiceServer interface {
	...
	// The successful removal depends on the change history of the dynamic synchronizer's confirmation response timeout
	// and the mediator reaction timeout parameters.
	CompletePartyOnboarding(context.Context, *CompletePartyOnboardingRequest) (*CompletePartyOnboardingResponse, error)
...
func (UnimplementedPartyManagementServiceServer) AddPartyAsync(context.Context, *AddPartyAsyncRequest) (*AddPartyAsyncResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddPartyAsync not implemented")
}
func (UnimplementedPartyManagementServiceServer) GetAddPartyStatus(context.Context, *GetAddPartyStatusRequest) (*GetAddPartyStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAddPartyStatus not implemented")
}
func (UnimplementedPartyManagementServiceServer) ExportPartyAcs(*ExportPartyAcsRequest, grpc.ServerStreamingServer[ExportPartyAcsResponse]) error {
	return status.Error(codes.Unimplemented, "method ExportPartyAcs not implemented")
}
func (UnimplementedPartyManagementServiceServer) ImportPartyAcs(grpc.ClientStreamingServer[ImportPartyAcsRequest, ImportPartyAcsResponse]) error {
	return status.Error(codes.Unimplemented, "method ImportPartyAcs not implemented")
}
func (UnimplementedPartyManagementServiceServer) GetHighestOffsetByTimestamp(context.Context, *GetHighestOffsetByTimestampRequest) (*GetHighestOffsetByTimestampResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHighestOffsetByTimestamp not implemented")
}
func (UnimplementedPartyManagementServiceServer) CompletePartyOnboarding(context.Context, *CompletePartyOnboardingRequest) (*CompletePartyOnboardingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompletePartyOnboarding not implemented")
}
...
func _PartyManagementService_CompletePartyOnboarding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompletePartyOnboardingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PartyManagementServiceServer).CompletePartyOnboarding(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PartyManagementService_CompletePartyOnboarding_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PartyManagementServiceServer).CompletePartyOnboarding(ctx, req.(*CompletePartyOnboardingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PartyManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CompletePartyOnboarding",
			Handler:    _PartyManagementService_CompletePartyOnboarding_Handler,
		},
	},
