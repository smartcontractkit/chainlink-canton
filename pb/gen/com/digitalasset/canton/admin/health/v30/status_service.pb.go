...
type NotInitialized struct {
	state                   protoimpl.MessageState                 `protogen:"open.v1"`
	Active                  bool                                   `protobuf:"varint,1,opt,name=active,proto3" json:"active,omitempty"`                                                                                                                                                           // Indicate if the node is active, usually true unless it's a replicated node that is passive
	WaitingForExternalInput NotInitialized_WaitingForExternalInput `protobuf:"varint,2,opt,name=waiting_for_external_input,json=waitingForExternalInput,proto3,enum=com.digitalasset.canton.admin.health.v30.NotInitialized_WaitingForExternalInput" json:"waiting_for_external_input,omitempty"` // Indicates whether the node is waiting for external input
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type Status struct {
	...
	Active         bool                   `protobuf:"varint,4,opt,name=active,proto3" json:"active,omitempty"`                                      // Indicate if the node is active, usually true unless it's a replicated node that is passive
	TopologyQueues *TopologyQueueStatus   `protobuf:"bytes,5,opt,name=topology_queues,json=topologyQueues,proto3" json:"topology_queues,omitempty"` // indicates the state of the topology queues (manager / dispatcher only where they exist)
	Components     []*ComponentStatus     `protobuf:"bytes,6,rep,name=components,proto3" json:"components,omitempty"`                               // Health state of component dependencies of the node
	Version        string                 `protobuf:"bytes,7,opt,name=version,proto3" json:"version,omitempty"`                                     // Version of the binary
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type HealthDumpResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Chunk         []byte                 `protobuf:"bytes,1,opt,name=chunk,proto3" json:"chunk,omitempty"` // A chunk of of the health dump file
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SetLogLevelRequest struct {
	...
	Level         string `protobuf:"bytes,1,opt,name=level,proto3" json:"level,omitempty"` // TODO(#18445) provide the ability to set it per logger
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_com_digitalasset_canton_admin_health_v30_status_service_proto_rawDesc = "" +
	...
	"\x11GetLastErrorTrace\x12B.com.digitalasset.canton.admin.health.v30.GetLastErrorTraceRequest\x1aC.com.digitalasset.canton.admin.health.v30.GetLastErrorTraceResponseB\xf1\x02\n" +
	",com.com.digitalasset.canton.admin.health.v30B\x12StatusServiceProtoP\x01Zfgithub.com/smartcontractkit/chainlink-canton/pb/gen/com/digitalasset/canton/admin/health/v30;healthv30\xa2\x02\x05CDCAH\xaa\x02(Com.Digitalasset.Canton.Admin.Health.V30\xca\x02(Com\\Digitalasset\\Canton\\Admin\\Health\\V30\xe2\x024Com\\Digitalasset\\Canton\\Admin\\Health\\V30\\GPBMetadata\xea\x02-Com::Digitalasset::Canton::Admin::Health::V30b\x06proto3"
