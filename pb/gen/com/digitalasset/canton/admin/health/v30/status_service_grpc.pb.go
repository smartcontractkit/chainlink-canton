...
func (UnimplementedStatusServiceServer) HealthDump(*HealthDumpRequest, grpc.ServerStreamingServer[HealthDumpResponse]) error {
	return status.Error(codes.Unimplemented, "method HealthDump not implemented")
}
...
func (UnimplementedStatusServiceServer) GetLastErrors(context.Context, *GetLastErrorsRequest) (*GetLastErrorsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLastErrors not implemented")
}
func (UnimplementedStatusServiceServer) GetLastErrorTrace(context.Context, *GetLastErrorTraceRequest) (*GetLastErrorTraceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLastErrorTrace not implemented")
}
