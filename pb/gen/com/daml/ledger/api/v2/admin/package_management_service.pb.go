...
const file_com_daml_ledger_api_v2_admin_package_management_service_proto_rawDesc = "" +
	...
	"\x0fpackage_version\x18\x03 \x01(\tR\x0epackageVersion\"\x94\x02\n" +
	...
	"\x18expected_topology_serial\x18\x04 \x01(\v2+.com.daml.ledger.api.v2.PriorTopologySerialR\x16expectedTopologySerial\"\xd0\x01\n" +
	...
	"\x13new_vetted_packages\x18\x02 \x01(\v2&.com.daml.ledger.api.v2.VettedPackagesR\x11newVettedPackages2\xab\x04\n" +
	...
	" com.com.daml.ledger.api.v2.adminB\x1dPackageManagementServiceProtoP\x01ZPgithub.com/smartcontractkit/chainlink-canton/pb/gen/com/daml/ledger/api/v2/admin\xa2\x02\x06CDLAVA\xaa\x02\x1cCom.Daml.Ledger.Api.V2.Admin\xca\x02\x1cCom\\Daml\\Ledger\\Api\\V2\\Admin\xe2\x02(Com\\Daml\\Ledger\\Api\\V2\\Admin\\GPBMetadata\xea\x02!Com::Daml::Ledger::Api::V2::Adminb\x06proto3"
...
var file_com_daml_ledger_api_v2_admin_package_management_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_com_daml_ledger_api_v2_admin_package_management_service_proto_goTypes = []any{
	(UploadDarFileRequest_VettingChange)(0), // 0: com.daml.ledger.api.v2.admin.UploadDarFileRequest.VettingChange
	(*ListKnownPackagesRequest)(nil),        // 1: com.daml.ledger.api.v2.admin.ListKnownPackagesRequest
	(*ListKnownPackagesResponse)(nil),       // 2: com.daml.ledger.api.v2.admin.ListKnownPackagesResponse
	(*PackageDetails)(nil),                  // 3: com.daml.ledger.api.v2.admin.PackageDetails
	(*UploadDarFileRequest)(nil),            // 4: com.daml.ledger.api.v2.admin.UploadDarFileRequest
	(*UploadDarFileResponse)(nil),           // 5: com.daml.ledger.api.v2.admin.UploadDarFileResponse
	(*ValidateDarFileRequest)(nil),          // 6: com.daml.ledger.api.v2.admin.ValidateDarFileRequest
	(*ValidateDarFileResponse)(nil),         // 7: com.daml.ledger.api.v2.admin.ValidateDarFileResponse
	(*VettedPackagesChange)(nil),            // 8: com.daml.ledger.api.v2.admin.VettedPackagesChange
	(*VettedPackagesRef)(nil),               // 9: com.daml.ledger.api.v2.admin.VettedPackagesRef
	(*UpdateVettedPackagesRequest)(nil),     // 10: com.daml.ledger.api.v2.admin.UpdateVettedPackagesRequest
	(*UpdateVettedPackagesResponse)(nil),    // 11: com.daml.ledger.api.v2.admin.UpdateVettedPackagesResponse
	(*VettedPackagesChange_Unvet)(nil),      // 12: com.daml.ledger.api.v2.admin.VettedPackagesChange.Unvet
	(*VettedPackagesChange_Vet)(nil),        // 13: com.daml.ledger.api.v2.admin.VettedPackagesChange.Vet
	(*timestamppb.Timestamp)(nil),           // 14: google.protobuf.Timestamp
	(*v2.PriorTopologySerial)(nil),          // 15: com.daml.ledger.api.v2.PriorTopologySerial
	(*v2.VettedPackages)(nil),               // 16: com.daml.ledger.api.v2.VettedPackages
}
var file_com_daml_ledger_api_v2_admin_package_management_service_proto_depIdxs = []int32{
	3,  // 0: com.daml.ledger.api.v2.admin.ListKnownPackagesResponse.package_details:type_name -> com.daml.ledger.api.v2.admin.PackageDetails
	14, // 1: com.daml.ledger.api.v2.admin.PackageDetails.known_since:type_name -> google.protobuf.Timestamp
	0,  // 2: com.daml.ledger.api.v2.admin.UploadDarFileRequest.vetting_change:type_name -> com.daml.ledger.api.v2.admin.UploadDarFileRequest.VettingChange
	13, // 3: com.daml.ledger.api.v2.admin.VettedPackagesChange.vet:type_name -> com.daml.ledger.api.v2.admin.VettedPackagesChange.Vet
	12, // 4: com.daml.ledger.api.v2.admin.VettedPackagesChange.unvet:type_name -> com.daml.ledger.api.v2.admin.VettedPackagesChange.Unvet
	8,  // 5: com.daml.ledger.api.v2.admin.UpdateVettedPackagesRequest.changes:type_name -> com.daml.ledger.api.v2.admin.VettedPackagesChange
	15, // 6: com.daml.ledger.api.v2.admin.UpdateVettedPackagesRequest.expected_topology_serial:type_name -> com.daml.ledger.api.v2.PriorTopologySerial
	16, // 7: com.daml.ledger.api.v2.admin.UpdateVettedPackagesResponse.past_vetted_packages:type_name -> com.daml.ledger.api.v2.VettedPackages
	16, // 8: com.daml.ledger.api.v2.admin.UpdateVettedPackagesResponse.new_vetted_packages:type_name -> com.daml.ledger.api.v2.VettedPackages
	9,  // 9: com.daml.ledger.api.v2.admin.VettedPackagesChange.Unvet.packages:type_name -> com.daml.ledger.api.v2.admin.VettedPackagesRef
	9,  // 10: com.daml.ledger.api.v2.admin.VettedPackagesChange.Vet.packages:type_name -> com.daml.ledger.api.v2.admin.VettedPackagesRef
	14, // 11: com.daml.ledger.api.v2.admin.VettedPackagesChange.Vet.new_valid_from_inclusive:type_name -> google.protobuf.Timestamp
	14, // 12: com.daml.ledger.api.v2.admin.VettedPackagesChange.Vet.new_valid_until_exclusive:type_name -> google.protobuf.Timestamp
	1,  // 13: com.daml.ledger.api.v2.admin.PackageManagementService.ListKnownPackages:input_type -> com.daml.ledger.api.v2.admin.ListKnownPackagesRequest
	4,  // 14: com.daml.ledger.api.v2.admin.PackageManagementService.UploadDarFile:input_type -> com.daml.ledger.api.v2.admin.UploadDarFileRequest
	6,  // 15: com.daml.ledger.api.v2.admin.PackageManagementService.ValidateDarFile:input_type -> com.daml.ledger.api.v2.admin.ValidateDarFileRequest
	10, // 16: com.daml.ledger.api.v2.admin.PackageManagementService.UpdateVettedPackages:input_type -> com.daml.ledger.api.v2.admin.UpdateVettedPackagesRequest
	2,  // 17: com.daml.ledger.api.v2.admin.PackageManagementService.ListKnownPackages:output_type -> com.daml.ledger.api.v2.admin.ListKnownPackagesResponse
	5,  // 18: com.daml.ledger.api.v2.admin.PackageManagementService.UploadDarFile:output_type -> com.daml.ledger.api.v2.admin.UploadDarFileResponse
	7,  // 19: com.daml.ledger.api.v2.admin.PackageManagementService.ValidateDarFile:output_type -> com.daml.ledger.api.v2.admin.ValidateDarFileResponse
	11, // 20: com.daml.ledger.api.v2.admin.PackageManagementService.UpdateVettedPackages:output_type -> com.daml.ledger.api.v2.admin.UpdateVettedPackagesResponse
