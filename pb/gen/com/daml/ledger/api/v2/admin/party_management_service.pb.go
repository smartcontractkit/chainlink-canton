...
type AllocateExternalPartyRequest struct {
	...
	MultiHashSignatures []*interactive.Signature `protobuf:"bytes,3,rep,name=multi_hash_signatures,json=multiHashSignatures,proto3" json:"multi_hash_signatures,omitempty"`
	// The id of the “Identity Provider“
...
func (x *AllocateExternalPartyRequest) GetMultiHashSignatures() []*interactive.Signature {
	if x != nil {
...
type AllocateExternalPartyRequest_SignedTransaction struct {
	...
	Signatures    []*interactive.Signature `protobuf:"bytes,2,rep,name=signatures,proto3" json:"signatures,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AllocateExternalPartyRequest_SignedTransaction) GetSignatures() []*interactive.Signature {
	if x != nil {
		return x.Signatures
	}
	return nil
...
const file_com_daml_ledger_api_v2_admin_party_management_service_proto_rawDesc = "" +
	"\n" +
	";com/daml/ledger/api/v2/admin/party_management_service.proto\x12\x1ccom.daml.ledger.api.v2.admin\x1a.com/daml/ledger/api/v2/admin/object_meta.proto\x1a#com/daml/ledger/api/v2/crypto.proto\x1aGcom/daml/ledger/api/v2/interactive/interactive_submission_service.proto\x1a google/protobuf/field_mask.proto\"\x19\n" +
	...
	"\rparty_details\x18\x01 \x01(\v2*.com.daml.ledger.api.v2.admin.PartyDetailsR\fpartyDetails\"\xe6\x03\n" +
	"\x1cAllocateExternalPartyRequest\x12\"\n" +
	"\fsynchronizer\x18\x01 \x01(\tR\fsynchronizer\x12\x85\x01\n" +
	"\x17onboarding_transactions\x18\x02 \x03(\v2L.com.daml.ledger.api.v2.admin.AllocateExternalPartyRequest.SignedTransactionR\x16onboardingTransactions\x12a\n" +
	"\x15multi_hash_signatures\x18\x03 \x03(\v2-.com.daml.ledger.api.v2.interactive.SignatureR\x13multiHashSignatures\x120\n" +
	"\x14identity_provider_id\x18\x04 \x01(\tR\x12identityProviderId\x1a\x84\x01\n" +
...
var file_com_daml_ledger_api_v2_admin_party_management_service_proto_goTypes = []any{
	...
	(*interactive.Signature)(nil),                          // 19: com.daml.ledger.api.v2.interactive.Signature
...
var file_com_daml_ledger_api_v2_admin_party_management_service_proto_depIdxs = []int32{
	...
	19, // 5: com.daml.ledger.api.v2.admin.AllocateExternalPartyRequest.multi_hash_signatures:type_name -> com.daml.ledger.api.v2.interactive.Signature
	...
	19, // 11: com.daml.ledger.api.v2.admin.AllocateExternalPartyRequest.SignedTransaction.signatures:type_name -> com.daml.ledger.api.v2.interactive.Signature
