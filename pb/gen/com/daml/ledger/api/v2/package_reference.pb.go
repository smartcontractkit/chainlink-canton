...
type VettedPackages struct {
	...
	TopologySerial *PriorTopologySerial `protobuf:"bytes,4,opt,name=topology_serial,json=topologySerial,proto3" json:"topology_serial,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *VettedPackages) GetTopologySerial() *PriorTopologySerial {
	if x != nil {
...
const file_com_daml_ledger_api_v2_package_reference_proto_rawDesc = "" +
	...
	"\x0fpackage_version\x18\x05 \x01(\tR\x0epackageVersion\"\xf9\x01\n" +
	...
	"\x0fsynchronizer_id\x18\x03 \x01(\tR\x0esynchronizerId\x12T\n" +
	"\x0ftopology_serial\x18\x04 \x01(\v2+.com.daml.ledger.api.v2.PriorTopologySerialR\x0etopologySerial\"l\n" +
...
var file_com_daml_ledger_api_v2_package_reference_proto_depIdxs = []int32{
	...
	3, // 3: com.daml.ledger.api.v2.VettedPackages.topology_serial:type_name -> com.daml.ledger.api.v2.PriorTopologySerial
	5, // 4: com.daml.ledger.api.v2.PriorTopologySerial.no_prior:type_name -> google.protobuf.Empty
