...
type GetActiveContractsRequest struct {
	...
	//
	// Deprecated: Marked as deprecated in com/daml/ledger/api/v2/state_service.proto.
...
const file_com_daml_ledger_api_v2_state_service_proto_rawDesc = "" +
	"\n" +
	"*com/daml/ledger/api/v2/state_service.proto\x12\x16com.daml.ledger.api.v2\x1a\"com/daml/ledger/api/v2/event.proto\x1a)com/daml/ledger/api/v2/reassignment.proto\x1a/com/daml/ledger/api/v2/transaction_filter.proto\"\xf2\x01\n" +
	"\x19GetActiveContractsRequest\x12E\n" +
	"\x06filter\x18\x01 \x01(\v2).com.daml.ledger.api.v2.TransactionFilterB\x02\x18\x01R\x06filter\x12\x1c\n" +
	"\averbose\x18\x02 \x01(\bB\x02\x18\x01R\averbose\x12(\n" +
