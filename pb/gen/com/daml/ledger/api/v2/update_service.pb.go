...
type GetUpdatesRequest struct {
	...
	//
	// Deprecated: Marked as deprecated in com/daml/ledger/api/v2/update_service.proto.
...
const file_com_daml_ledger_api_v2_update_service_proto_rawDesc = "" +
	...
	"\freassignment\x18\x02 \x01(\v2$.com.daml.ledger.api.v2.ReassignmentH\x00R\freassignment\x12W\n" +
	"\x11offset_checkpoint\x18\x03 \x01(\v2(.com.daml.ledger.api.v2.OffsetCheckpointH\x00R\x10offsetCheckpoint:\x02\x18\x01B\b\n" +
	"\x06update\"\xc4\x01\n" +
	...
	"\x12transaction_format\x18\x03 \x01(\v2).com.daml.ledger.api.v2.TransactionFormatR\x11transactionFormat:\x02\x18\x01\"\xc5\x01\n" +
	"\x19GetTransactionByIdRequest\x12\x1b\n" +
	"\tupdate_id\x18\x01 \x01(\tR\bupdateId\x12-\n" +
	"\x12requesting_parties\x18\x02 \x03(\tR\x11requestingParties\x12X\n" +
	"\x12transaction_format\x18\x03 \x01(\v2).com.daml.ledger.api.v2.TransactionFormatR\x11transactionFormat:\x02\x18\x01\"k\n" +
	"\x1aGetTransactionTreeResponse\x12I\n" +
	"\vtransaction\x18\x01 \x01(\v2'.com.daml.ledger.api.v2.TransactionTreeR\vtransaction:\x02\x18\x01\"c\n" +
	"\x16GetTransactionResponse\x12E\n" +
	"\vtransaction\x18\x01 \x01(\v2#.com.daml.ledger.api.v2.TransactionR\vtransaction:\x02\x18\x01\"}\n" +
	...
	"\rUpdateService\x12e\n" +
	"\n" +
	"GetUpdates\x12).com.daml.ledger.api.v2.GetUpdatesRequest\x1a*.com.daml.ledger.api.v2.GetUpdatesResponse0\x01\x12r\n" +
	"\x0eGetUpdateTrees\x12).com.daml.ledger.api.v2.GetUpdatesRequest\x1a..com.daml.ledger.api.v2.GetUpdateTreesResponse\"\x03\x88\x02\x010\x01\x12\x8c\x01\n" +
	"\x1aGetTransactionTreeByOffset\x125.com.daml.ledger.api.v2.GetTransactionByOffsetRequest\x1a2.com.daml.ledger.api.v2.GetTransactionTreeResponse\"\x03\x88\x02\x01\x12\x84\x01\n" +
	"\x16GetTransactionTreeById\x121.com.daml.ledger.api.v2.GetTransactionByIdRequest\x1a2.com.daml.ledger.api.v2.GetTransactionTreeResponse\"\x03\x88\x02\x01\x12\x84\x01\n" +
	"\x16GetTransactionByOffset\x125.com.daml.ledger.api.v2.GetTransactionByOffsetRequest\x1a..com.daml.ledger.api.v2.GetTransactionResponse\"\x03\x88\x02\x01\x12|\n" +
