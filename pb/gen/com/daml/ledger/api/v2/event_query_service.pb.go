...
type GetEventsByContractIdRequest struct {
	...
	//
	// Deprecated: Marked as deprecated in com/daml/ledger/api/v2/event_query_service.proto.
...
const file_com_daml_ledger_api_v2_event_query_service_proto_rawDesc = "" +
	"\n" +
	"0com/daml/ledger/api/v2/event_query_service.proto\x12\x16com.daml.ledger.api.v2\x1a\"com/daml/ledger/api/v2/event.proto\x1a/com/daml/ledger/api/v2/transaction_filter.proto\"\xba\x01\n" +
	"\x1cGetEventsByContractIdRequest\x12\x1f\n" +
	"\vcontract_id\x18\x01 \x01(\tR\n" +
	"contractId\x121\n" +
	"\x12requesting_parties\x18\x02 \x03(\tB\x02\x18\x01R\x11requestingParties\x12F\n" +
