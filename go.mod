...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.115.1
...
require (
	...
	github.com/smartcontractkit/chainlink-evm/gethwrappers v0.0.0-20260629144841-3b5a6de5bcdb // indirect
