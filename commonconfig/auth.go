...
type AuthConfig struct {
	...
	//nolint:struct-tag // optional_jwt
	JWT string `toml:"jwt,omitempty" validate:"required_if=Type static,excluded_unless=Type static,optional_jwt"`
	...
	//nolint:struct-tag // optional_url
	AuthURL string `toml:"auth_url,omitempty" validate:"required_if=Type clientCredentials,required_if=Type authorizationCode,optional_url"`
