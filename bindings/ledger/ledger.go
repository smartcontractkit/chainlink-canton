...
func commandsToProto(cmd *Commands) *v2.Commands {
	pbCmd := &v2.Commands{
...
func commandsArrayToProto(cmds []*Command) []*v2.Command {
...
func commandToProto(cmd *Command) *v2.Command {
	pbCmd := &v2.Command{}
...
func filtersToProto(filters *Filters) *v2.Filters {
	if filters == nil {
		return nil
	}
...
func templateFilterToProto(tf *TemplateFilter) *v2.TemplateFilter {
	if tf == nil {
		return nil
	}
...
func interfaceFilterToProto(iface *InterfaceFilter) *v2.InterfaceFilter {
	if iface == nil {
		return nil
	}
...
func eventFormatToProto(format *EventFormat) *v2.EventFormat {
	if format == nil {
		return nil
	}
...
func updateFormatToProto(format *EventFormat) *v2.UpdateFormat {
	if format == nil {
		return nil
	}
...
func createdEventFromProto(pb *v2.CreatedEvent) *CreatedEvent {
	if pb == nil {
		return nil
	}
	...
	if len(pb.InterfaceViews) > 0 {
		event.InterfaceViews = make([]*InterfaceView, len(pb.InterfaceViews))
...
func interfaceViewFromProto(pb *v2.InterfaceView) *InterfaceView {
	if pb == nil {
		return nil
	}
...
func archivedEventFromProto(pb *v2.ArchivedEvent) *ArchivedEvent {
	if pb == nil {
		return nil
	}
					...
					Fields: []*v2.RecordField{
						{
							Label: "microseconds",
							Value: &v2.Value{
								Sum: &v2.Value_Int64{Int64: time.Duration(v).Microseconds()},
							},
						},
					},
				},
...
func prepareSubmissionRequestToProto(req *PrepareSubmissionRequest) *interactive.PrepareSubmissionRequest {
	if req == nil {
		return nil
	}
...
func minLedgerTimeToProto(mlt *MinLedgerTime) *interactive.MinLedgerTime {
...
func disclosedContractsToProto(contracts []*DisclosedContract) []*v2.DisclosedContract {
	if contracts == nil {
		return nil
	}
...
func disclosedContractToProto(contract *DisclosedContract) *v2.DisclosedContract {
	if contract == nil {
		return nil
	}
...
func prefetchContractKeysToProto(keys []*PrefetchContractKey) []*v2.PrefetchContractKey {
	if keys == nil {
		return nil
	}
...
func prepareSubmissionResponseFromProto(pb *interactive.PrepareSubmissionResponse) *PrepareSubmissionResponse {
	if pb == nil {
		return nil
	}

	resp := &PrepareSubmissionResponse{
		PreparedTransactionHash: pb.PreparedTransactionHash,
		HashingSchemeVersion:    HashingSchemeVersion(pb.HashingSchemeVersion),
	}
...
func executeSubmissionRequestToProto(req *ExecuteSubmissionRequest) *interactive.ExecuteSubmissionRequest {
	if req == nil {
		return nil
	}
...
func singlePartySignaturesToProto(sigs []*SinglePartySignatures) []*interactive.SinglePartySignatures {
	if sigs == nil {
		return nil
	}
...
func signaturesToProto(sigs []*Signature) []*v2.Signature {
	if sigs == nil {
		return nil
	}
...
func unassignedEventFromProto(pb *v2.UnassignedEvent) *UnassignedEvent {
	if pb == nil {
		return nil
	}
...
func assignedEventFromProto(pb *v2.AssignedEvent) *AssignedEvent {
	if pb == nil {
		return nil
	}
...
func exercisedEventFromProto(pb *v2.ExercisedEvent) *ExercisedEvent {
	if pb == nil {
		return nil
	}
