...
import (
	...
	"github.com/smartcontractkit/chainlink-canton/bindings/codegen/astgen"
	model2 "github.com/smartcontractkit/chainlink-canton/bindings/codegen/model"
...
func GetAST(payload []byte, manifest *model2.Manifest, ifcByModule map[string]model2.InterfaceMap, externalPackages model2.ExternalPackages) (*model2.Package, error) {
	...
	fmt.Println("IMPORTED PACKAGES: ", importedPackages)
