...
func main() {
	...
	var (
		indexerURL              = flag.String("indexer-url", stagingenv.String(defaultIndexerURL, "STAGING_CANTON_TO_EVM_INDEXER_URL"), "Indexer base URL")
		rpcURL                  = flag.String("rpc", stagingenv.String("", "STAGING_CANTON_TO_EVM_RPC_URL"), "Destination EVM RPC URL")
		privateKeyHex           = flag.String("private-key", stagingenv.String("", "STAGING_CANTON_TO_EVM_PRIVATE_KEY", "PRIVATE_KEY"), "Hex private key for the EVM executor")
		messageIDHex            = flag.String("message-id", "", "0x-prefixed message ID to execute")
		offRampOverride         = flag.String("offramp", stagingenv.String("", "STAGING_CANTON_TO_EVM_OFFRAMP"), "Destination OffRamp override; default uses the indexed message off-ramp")
	...
	requireString(*rpcURL, "-rpc", "STAGING_CANTON_TO_EVM_RPC_URL")
	requireString(*privateKeyHex, "-private-key", "STAGING_CANTON_TO_EVM_PRIVATE_KEY or PRIVATE_KEY")
	requireString(*indexerURL, "-indexer-url", "STAGING_CANTON_TO_EVM_INDEXER_URL")
