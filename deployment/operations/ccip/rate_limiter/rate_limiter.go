...
var DeployInbound = contract.NewDeploy(contract.DeployParams[common.RateLimiter]{
...
var DeployOutbound = contract.NewDeploy(contract.DeployParams[common.RateLimiter]{
