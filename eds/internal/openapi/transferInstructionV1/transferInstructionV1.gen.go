...
// Valid indicates whether the value is a known member of the TransferFactoryWithChoiceContextTransferKind enum.
func (e TransferFactoryWithChoiceContextTransferKind) Valid() bool {
	switch e {
	case Direct:
		return true
	case Offer:
...
type ClientInterface interface {
	...
	// GetTransferFactoryWithBody performs a POST /registry/transfer-instruction/v1/transfer-factory (the `GetTransferFactory` operationId) request,
	...
	// GetTransferFactory performs a POST /registry/transfer-instruction/v1/transfer-factory (the `GetTransferFactory` operationId) request.
	...
	// GetTransferInstructionAcceptContextWithBody performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/accept (the `GetTransferInstructionAcceptContext` operationId) request,
	// with any type of body and a specified content type.
	//
	...
	// GetTransferInstructionAcceptContext performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/accept (the `GetTransferInstructionAcceptContext` operationId) request.
	// Takes a body of the `application/json` content type.
	//
	// Get the choice context to accept a transfer instruction.
	...
	// GetTransferInstructionRejectContextWithBody performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/reject (the `GetTransferInstructionRejectContext` operationId) request,
	// with any type of body and a specified content type.
	//
	...
	// GetTransferInstructionRejectContext performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/reject (the `GetTransferInstructionRejectContext` operationId) request.
	// Takes a body of the `application/json` content type.
	//
	// Get the choice context to reject a transfer instruction.
	...
	// GetTransferInstructionWithdrawContextWithBody performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw (the `GetTransferInstructionWithdrawContext` operationId) request,
	// with any type of body and a specified content type.
	//
	...
	// GetTransferInstructionWithdrawContext performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw (the `GetTransferInstructionWithdrawContext` operationId) request.
	// Takes a body of the `application/json` content type.
	//
	// Get the choice context to withdraw a transfer instruction.
...
// NewGetTransferFactoryRequestWithBody constructs an http.Request for the GetTransferFactory method, with any body, and a specified content type
...
// NewGetTransferInstructionAcceptContextRequestWithBody constructs an http.Request for the GetTransferInstructionAcceptContext method, with any body, and a specified content type
func NewGetTransferInstructionAcceptContextRequestWithBody(server string, transferInstructionId string, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "transferInstructionId", transferInstructionId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
// NewGetTransferInstructionRejectContextRequestWithBody constructs an http.Request for the GetTransferInstructionRejectContext method, with any body, and a specified content type
...
// NewGetTransferInstructionWithdrawContextRequestWithBody constructs an http.Request for the GetTransferInstructionWithdrawContext method, with any body, and a specified content type
...
type ClientWithResponsesInterface interface {
	...
	// GetTransferFactoryWithBodyWithResponse performs a POST /registry/transfer-instruction/v1/transfer-factory (the `GetTransferFactory` operationId) request,
	// with any type of body and a specified content type.
	//
	// Get the factory and choice context for executing a direct transfer.
	//
	...
	// GetTransferFactoryWithResponse performs a POST /registry/transfer-instruction/v1/transfer-factory (the `GetTransferFactory` operationId) request.
	...
	// GetTransferInstructionAcceptContextWithBodyWithResponse performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/accept (the `GetTransferInstructionAcceptContext` operationId) request,
	// with any type of body and a specified content type.
	//
	// Get the choice context to accept a transfer instruction.
	//
	...
	// GetTransferInstructionAcceptContextWithResponse performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/accept (the `GetTransferInstructionAcceptContext` operationId) request.
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Get the choice context to accept a transfer instruction.
	...
	// GetTransferInstructionRejectContextWithBodyWithResponse performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/reject (the `GetTransferInstructionRejectContext` operationId) request,
	// with any type of body and a specified content type.
	//
	// Get the choice context to reject a transfer instruction.
	//
	...
	// GetTransferInstructionRejectContextWithResponse performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/reject (the `GetTransferInstructionRejectContext` operationId) request.
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Get the choice context to reject a transfer instruction.
	...
	// GetTransferInstructionWithdrawContextWithBodyWithResponse performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw (the `GetTransferInstructionWithdrawContext` operationId) request,
	// with any type of body and a specified content type.
	//
	// Get the choice context to withdraw a transfer instruction.
	//
	...
	// GetTransferInstructionWithdrawContextWithResponse performs a POST /registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw (the `GetTransferInstructionWithdrawContext` operationId) request.
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Get the choice context to withdraw a transfer instruction.
...
func (r GetTransferFactoryResp) GetJSON200() *TransferFactoryWithChoiceContext {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r GetTransferFactoryResp) GetJSON400() *N400 {
	return r.JSON400
}

// GetJSON404 returns the response for an HTTP 404 `application/json` response
func (r GetTransferFactoryResp) GetJSON404() *N404 {
	return r.JSON404
}

// GetBody returns the raw response body bytes
func (r GetTransferFactoryResp) GetBody() []byte {
	return r.Body
}
...
func (r GetTransferFactoryResp) ContentType() string {
	if r.HTTPResponse != nil {
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r GetTransferInstructionAcceptContextResp) GetJSON200() *ChoiceContext {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r GetTransferInstructionAcceptContextResp) GetJSON400() *N400 {
	return r.JSON400
}

// GetJSON404 returns the response for an HTTP 404 `application/json` response
func (r GetTransferInstructionAcceptContextResp) GetJSON404() *N404 {
	return r.JSON404
}

// GetBody returns the raw response body bytes
func (r GetTransferInstructionAcceptContextResp) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetTransferInstructionAcceptContextResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r GetTransferInstructionRejectContextResp) GetJSON200() *ChoiceContext {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r GetTransferInstructionRejectContextResp) GetJSON400() *N400 {
	return r.JSON400
}

// GetJSON404 returns the response for an HTTP 404 `application/json` response
func (r GetTransferInstructionRejectContextResp) GetJSON404() *N404 {
	return r.JSON404
}

// GetBody returns the raw response body bytes
func (r GetTransferInstructionRejectContextResp) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetTransferInstructionRejectContextResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r GetTransferInstructionWithdrawContextResp) GetJSON200() *ChoiceContext {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r GetTransferInstructionWithdrawContextResp) GetJSON400() *N400 {
	return r.JSON400
}

// GetJSON404 returns the response for an HTTP 404 `application/json` response
func (r GetTransferInstructionWithdrawContextResp) GetJSON404() *N404 {
	return r.JSON404
}

// GetBody returns the raw response body bytes
func (r GetTransferInstructionWithdrawContextResp) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetTransferInstructionWithdrawContextResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
func (siw *ServerInterfaceWrapper) GetTransferInstructionAcceptContext(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "transferInstructionId", c.Param("transferInstructionId"), &transferInstructionId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
