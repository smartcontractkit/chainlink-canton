...
func (_m *MockServerStreamingClient[Res]) Recv() (*Res, error) {
	ret := _m.Called()
...
func (_c *MockServerStreamingClient_Recv_Call[Res]) Return(_a0 *Res, _a1 error) *MockServerStreamingClient_Recv_Call[Res] {
	_c.Call.Return(_a0, _a1)
	return _c
}
